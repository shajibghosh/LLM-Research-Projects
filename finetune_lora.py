...
LR = 5e-4
NUM_EPOCHS = 5
LOG_DIR = "logs_lora_general"
MODEL_SAVE_DIR = "trained_models_lora_general"
RESULTS_DIR = "logs_lora_general"
...
if __name__ == "__main__":
    for dataset_name in BENCHMARK_DATASETS.keys():
        ...
        for model_name, model_path in MODELS.items():
            ...
            model = LoRAFinetuner(model_path, tokenized_dataset)
    ...
    if RANK == 0:
        ...
        print_rank_0("\nTo visualize training logs, run: tensorboard --logdir logs_lora_general")
